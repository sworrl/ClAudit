...
<!-- COUNTER:START -->
### 📊 469 open false-positive blocks reported by ClAudit right now

Real cyber/aup API false positives across **all** ClAudit users, live from [`anthropics/claude-code`](https://github.com/anthropics/claude-code/issues?q=is%3Aissue+is%3Aopen+%22Filed+automatically+by+ClAudit%22). **86 closed by Anthropic** · _updated 2026-08-30 12:55 UTC_
...
<!-- POLL:START -->
**Will Anthropic fix Claude Code's false-positive blocking, or will it stay broken?**  ·  _4 vote(s), updated 2026-08-30 12:55 UTC_
