...
<!-- COUNTER:START -->
### 📊 143 open false-positive blocks reported by ClAudit right now

Real cyber/aup API false positives across **all** ClAudit users, live from [`anthropics/claude-code`](https://github.com/anthropics/claude-code/issues?q=is%3Aissue+is%3Aopen+%22Filed+automatically+by+ClAudit%22). **466 closed by Anthropic** · _updated 2026-09-14 01:09 UTC_
...
<sub>Three lines: open cyber/aup false positives (cyan), closed by Anthropic (green), and the 191 auto-mode-classifier (harness) reports ClAudit withdrew (muted), tracked separately and not counted as closed tickets.</sub>
<!-- COUNTER:END -->
...
<!-- POLL:START -->
**Will Anthropic fix Claude Code's false-positive blocking, or will it stay broken?**  ·  _4 vote(s), updated 2026-09-14 01:09 UTC_
